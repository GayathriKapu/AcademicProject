  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        ...
        <table width=405 height="267" border=0 align="center" cellpadding=0 cellspacing=0 bgcolor=#FFFFFF>
<tr>
<td width="405" height="189" align=center><span class="style9"><span class="style10"><font class=sb4>Sorry.</font><BR>
      <BR>
      <font class=sb3>
Your login failed.<BR>
      </font></span></span>
  <TABLE cellSpacing=0 cellPadding=0 border=0 height="7">
    <TR><TD height=7 class="style12"></TD></TR>
  </TABLE>
  <strong><font class="sb3"><span class="style9">This happens due to - Incorrect Username / Incorrect password<BR>
    </span> </font>  </strong>
  <TABLE cellSpacing=0 cellPadding=0 border=0 width="10">
    <TR>
      <TD width="10" height=9 class="style12"></TD></TR>
  </TABLE>
  <strong><font class="sb3"><span class="style9">In case you have forgotten your password,<BR>
    </span> </font>  </strong>
  <TABLE cellSpacing=0 cellPadding=0 border=0>
    <TR><TD height=9 class="style12"></TD></TR>
  </TABLE>
  <strong><font class="sb3"><span class="style9">click&nbsp; here to re enter correct&nbsp; username or password on homepage. </span></font></strong><font class="sb3"><BR>
  <BR>
